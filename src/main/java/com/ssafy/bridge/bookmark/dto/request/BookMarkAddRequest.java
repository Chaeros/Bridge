package com.ssafy.bridge.bookmark.dto.request;
...
public class BookMarkAddRequest {
	...
	public BookMarkAddRequest(int contentId, int contentTypeId, String title, String addr1,
	...
	public String toString() {
		return "BookMarkAddRequest [contentId=" + contentId + ", contentTypeId="
